  ...
  return (
    <Fragment>
      ...
      <div className='flex flex-col items-start px-28 pb-20 pt-14 max-xl:px-20 max-md:px-6 max-md:pb-12 max-md:pt-10'>
        <div className='mb-6 flex w-full justify-between gap-6 px-2 max-md:mb-4 max-sm:flex-col'>
          <div className='flex flex-col'>
            <h1 className='w-full font-galada text-6xl font-medium max-lg:text-[44px]'>
              Barbearia Sr. Xavier
            </h1>
